...
public class GridWriter {
	...
	/**
	 * This method returns the current number of GridItems stored in GridWriter.
	 * @return items.length The number of GridWriter items created
	 */
	public int size() {	
		return size;
	}
	...
	/**
	 * Returns the stored GridItems objects by index.
	 * @param index
	 * @return items[index] Returns the GridItem object
	 */
	public GridItem get(int index) {
		...
		if (index >= size) {
			throw new IndexOutOfBoundsException("Error: The index you specified doesn't have anything in it!");
		}
		return items[index];
	}
}
